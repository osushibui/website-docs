...
3. Don't **spam or flood**, unless you're occasionally sending a link to e.g. Twitch when you're streaming Shibui when no discussion is going on.
...
7. Don't make any kind of **cheating accusation** (Message a staff member on [Discord](https://discord.gg/vY29JhD) with evidence or suspicion to handle the situation correctly!)
...
#### _This is how we handle cheaters and multiaccounters on Shibui._

1. Cheating and multiaccount is strictly prohibited.
2. It doesn't matter if you cheated on any other osu! server - we only care about what you did on Shibui.
3. Multiaccounts are **NOT** allowed, with the **SOLE EXCEPTION OF CHAT BOTS**.  If you are developing one and need an account for it,  join our [Discord](https://discord.gg/vY29JhD)
4. We reserve the right to change these rules as we see fit.

<h3><i class="list layout icon"></i> Miscellaneous</h3>

1. You can change your profile flag by asking in our [Discord](https://discord.gg/vY29JhD) and we may change your flag if we have good reason to.
2. Name changes are handled through our [Discord](https://discord.gg/vY29JhD) also.
